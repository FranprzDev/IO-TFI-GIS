 ...
 * simulation runs/replicas: doing so leaks a value generated by one RNG stream
 * into another, which breaks seeded reproducibility and contaminates samples.
 * Create one sampler per replica so each RNG stream owns its spare.
 */
